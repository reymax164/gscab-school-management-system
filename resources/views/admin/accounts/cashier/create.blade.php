<x-layouts.app title="Admin | Add Cashier" header="Add New Cashier" class="p-4 md:p-6">
    ...
    <form action="{{ route('admin.accounts.cashier.store') }}" method="POST">
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden mb-8">
            ...
            <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
                <h2 class="text-lg font-semibold text-gray-900">New Cashier Account</h2>
                <p class="text-sm text-gray-500 mt-1">Fill in the details below to register a new cashier.</p>
            </div>
            ...
            <div class="p-6 space-y-10">
                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <x-form.input label="Role" name="role_display" value="Cashier" disabled />
                    </div>
                </section>
