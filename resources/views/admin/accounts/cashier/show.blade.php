<x-layouts.app title="Admin | Cashier Details" header="Cashier Details" class="p-4 md:p-6">
    ...
    <div class="flex justify-between items-center mb-4 px-2 md:px-0">
        ...
        <a href="{{ route('admin.accounts.cashier.edit', $cashier->id) }}"
    ...
    {{-- TODO: routes/admin.php uses an inline closure with no controller; $cashier (User model where role = cashier) is not yet supplied --}}
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <span class="text-gray-900 font-medium">{{ $cashier->email ?? 'N/A' }}</span>
                    </div>
                    <div>
