<x-layouts.app title="Admin | Teacher Details" header="Teacher Details" class="p-4 md:p-6">
    ...
    {{-- TODO: controller does not yet supply $teacher (Teacher model with user relation loaded) --}}
        ...
        <div class="p-6 space-y-10">
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <span class="text-gray-900 font-medium">{{ $teacher->user->email ?? 'N/A' }}</span>
                    </div>
                    <div>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        <span class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Employee ID</span>
                        <span class="text-gray-900 font-medium">{{ $teacher->employee_id }}</span>
                    </div>
                    <div>
                        <span class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Department</span>
                        <span class="text-gray-900 font-medium">{{ $teacher->department_id ?? 'N/A' }}</span>
                    </div>
                    <div>
                        <span class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Hire Date</span>
                        <span class="text-gray-900 font-medium">{{ \Carbon\Carbon::parse($teacher->hire_date)->format('F d, Y') }}</span>
                    </div>
                </div>
            </section>
