<x-layouts.app title="Admin | Add Registrar" header="Add New Registrar" class="p-4 md:p-6">
    ...
    {{-- TODO: routes/admin.php uses an inline closure with no controller; admin.accounts.registrar.store does not exist yet --}}
    <form action="{{ route('admin.accounts.registrar.store') }}" method="POST">
        @csrf
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden mb-8">
            ...
            <div class="px-6 py-5 border-b border-gray-200 bg-gray-50">
                <h2 class="text-lg font-semibold text-gray-900">New Registrar Account</h2>
                <p class="text-sm text-gray-500 mt-1">Fill in the details below to register a new registrar.</p>
            </div>
            ...
            <div class="p-6 space-y-10">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <div class="relative flex-1">
                                    <input :type="visible ? 'text' : 'password'" name="password" id="password" x-model="password" readonly required
                                           placeholder="Use Generate Password to set the account password"
                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <x-form.input label="Role" name="role_display" value="Registrar" disabled />
                    </div>
                </section>
