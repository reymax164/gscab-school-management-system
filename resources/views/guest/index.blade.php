...
>
    ...
    >
        ...
        <div class="flex flex-col gap-3 w-full">
            ...
            <!-- user login -->
            <a href="{{ route('auth.login') }}" class="w-full px-4 py-2 bg-blue-900 text-white font-medium rounded-full hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2 transition-colors text-center">
                Login
            </a>
