...
<div {{ $attributes->merge(['class' => 'col-span-1 bg-white rounded-lg h-48 border-l-8 border-l-blue-900 shadow-md hover:shadow-lg transition-shadow py-4 px-6 flex flex-col overflow-hidden']) }}>
  ...
  <div class="flex items-center gap-2 mb-2 shrink-0">
    ...
    @endif
    <p class="text-blue-900 font-semibold text-lg truncate">{{ $title }}</p>
  </div>
