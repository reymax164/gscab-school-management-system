...
<div class="mt-6 flex-1 bg-white border border-neutral-300 rounded-md shadow-sm hover:shadow-md overflow-x-auto dark:bg-neutral-800 dark:border-neutral-700 dark:border">
