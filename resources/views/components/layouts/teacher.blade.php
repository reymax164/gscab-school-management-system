...
<x-layouts.base :title="'Teacher | ' . $title">
  ...
  <header class="flex justify-between items-center w-full py-4 px-8 pl-64 top-0 z-10">
    ...
    <div class="flex items-center gap-3">
      <div class="text-right">
        ...
        <p class="text-sm text-gray-600 dark:text-neutral-300">Teacher</p>
      </div>
  ...
  <x-nav.bar>
    <x-nav.link route="teacher.dashboard" label="Dashboard"/>
    <x-nav.link route="teacher.student_list" label="Student List"/>
    <x-nav.link route="teacher.grades" label="Student Grades"/>
    <x-nav.link route="teacher.schedule" label="Schedule"/>
  </x-nav.bar>
