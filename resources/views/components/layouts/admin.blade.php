...
<x-layouts.base>
  ...
  <header class="flex justify-between items-center w-full py-4 px-8 pl-64 top-0 z-10">
    ...
    <div class="flex items-center gap-3">
      <div class="text-right">
        ...
        <p class="text-sm text-gray-600 dark:text-neutral-300">admin</p>
      </div>
  ...
  <x-nav.bar>
    ...
    <x-nav.link route="admin.students" label="Manage Students"/>
    <x-nav.link route="admin.staff" label="Manage Staff"/>
    <x-nav.link route="admin.schedules" label="Manage Schedules"/>
    <x-nav.link route="admin.news" label="Post News"/>
    <x-nav.link route="admin.feedbacks" label="Feedbacks"/>
  </x-nav.bar>
