...
<x-layouts.base>
  ...
  <header class="flex justify-between items-center w-full py-4 px-8 pl-64 top-0 z-10">
    ...
    <div class="flex items-center gap-3">
      <div class="text-right">
        ...
        <p class="text-sm text-gray-600 dark:text-neutral-300">Registrar</p>
      </div>
  ...
  <x-nav.bar>
    <x-nav.link route="registrar.dashboard" label="Dashboard"/>
    <x-nav.link route="registrar.records" label="Student Records"/>
    <x-nav.link route="registrar.admissions" label="Admissions"/>
    <x-nav.link route="registrar.reports" label="Reports"/>
  </x-nav.bar>
